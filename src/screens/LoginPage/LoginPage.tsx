      ...
      <section className="py-8 md:py-16">
        <div className="max-w-[1440px] mx-auto px-4 md:px-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 max-w-md">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="remember-me-desktop" className="ml-2 block text-sm text-gray-700">
                      Remember me
                    </label>
                  </div>
          ...
          <div className="md:hidden">
            <div className="mb-8 bg-black rounded-2xl overflow-hidden shadow-lg mx-auto max-w-xs">
              <img 
                src="/laptop-login.png" 
                alt="Laptop" 
                className="w-full h-auto object-cover"
            ...
            <div className="px-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button 
                  type="submit"
                  className="w-full bg-[#04364A] hover:bg-[#032a38] text-white py-2 text-sm"
                  disabled={isLoading}
                >
                  {isLoading ? "Logging in..." : "Log in"}
                </Button>
